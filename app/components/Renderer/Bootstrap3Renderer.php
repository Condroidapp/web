...
namespace App\BootstrapFormRenderer;
use Nette;
 ...
 * @author Jan Langer - bootstrap 3 modifications
 */
class Bootstrap3Renderer extends Nette\Object implements Nette\Forms\IFormRenderer
{
    ...
    private function prepareControl(Controls\BaseControl $control)
    {
        ...
        $formHorizontal = self::isFormHorizontal($this->form);
        ...
        if ($control instanceof Nette\Forms\ISubmitterControl) {
            ...
            if(!$formHorizontal && $control instanceof Controls\Checkbox) {
    ...
    public static function isFormHorizontal($form) {
        return in_array('form-horizontal', $form->getElementPrototype()->class);
    }
